...
\institute{Alexander M. van Oers \at
           ...
           \and
           Leo R.M. Maas \at
           Inst. for Marine and Atmospheric research Utrecht, Utrecht University, Princetonplein 5, 3584 CC, Utrecht, The Netherlands
}
...
\section{Correction}
\label{sec:cor}
%\subsection{Permanent Compensation}
...
\begin{subfigure}{.5\linewidth}
	...
	\subcaption{Calibration Image: Filled with water with known $n$}\label{fig:fresh0side}
\end{subfigure}\\
\begin{subfigure}{.5\linewidth}
...
\begin{subfigure}{.5\linewidth}
	\centering \includegraphics[width = \textwidth]{TwoLayerHorizontalAveraged}
		\subcaption{$n$ profile for Calibration and Deformed Images}\label{fig:nprofiles0side}
\end{subfigure}
