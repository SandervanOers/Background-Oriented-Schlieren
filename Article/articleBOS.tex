...
\begin{subfigure}{.5\linewidth}
		\centering \includegraphics[width = \textwidth]{Refsimplefrontal}
		\subcaption{Reference Image: Filled with air}\label{fig:air0simplefrontal}
\end{subfigure}%
\begin{subfigure}{.5\linewidth}
	\centering \includegraphics[width = \textwidth]{deformedsimplefrontal}
...
\end{subfigure}%
\begin{subfigure}{.5\linewidth}
	\centering \includegraphics[width = \textwidth]{DXsimplefrontal}
	\subcaption{$\Delta x$ from DIC}\label{fig:DXsimplefrontal}
\end{subfigure}\\
	\begin{subfigure}{.5\linewidth}
	\centering \includegraphics[width = \textwidth]{DYsimplefrontal}
...
\begin{figure}[htbp]
		...
		\caption{$\log_{10}S(b,c)$}\label{fig:Sac}
\end{figure}
\begin{figure}[htbp]
...
%	\begin{subfigure}{.5\linewidth}
%		\centering \includegraphics[width = \textwidth]{leastsquaresab.png}
%		\subcaption{$S(a,b)$}\label{fig:Sab}
%	\end{subfigure}%
%	\begin{subfigure}{.5\linewidth}
%	\centering \includegraphics[width = \textwidth]{leastsquaresac.png}
%	\subcaption{$S(a,c)$}\label{fig:Sac}
%	\end{subfigure}\\
%	\begin{subfigure}{.5\linewidth}
%	\centering \includegraphics[width = \textwidth]{leastsquaresad.png}
%	\subcaption{$S(a,d)$}\label{fig:SaLm}
%	\end{subfigure}%
%	\begin{subfigure}{.5\linewidth}
%		\centering \includegraphics[width = \textwidth]{leastsquaresbc.png}
%		\subcaption{$S(b,c)$}\label{fig:Sac}
%	\end{subfigure}\\
%	\begin{subfigure}{.5\linewidth}
%	\centering \includegraphics[width = \textwidth]{leastsquaresbd.png}
%	\subcaption{$S(b,d)$}\label{fig:SbLm}
%	\end{subfigure}%
%	\begin{subfigure}{.5\linewidth}
%		\centering \includegraphics[width = \textwidth]{leastsquarescd.png}
%		\subcaption{$S(c,d)$}\label{fig:ScLm}
%	\end{subfigure}
%	\caption{Calibration: $S$ as a function of $\underline{\alpha}$.}
%	\label{fig:cal}
%\end{figure}
