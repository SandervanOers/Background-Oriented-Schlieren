function [F] = SnellsLaw_mini3(~,~, phi_x_2_0, phi_y_2_0, alpha, beta, n1, n2, A, T, L_test)
...
%     phi_y_2_1 = atand(tt2(2,:)./tt2(3,:))';
    ...
    phi_x_2_2 = atand(tt2(1,:)./tt2(3,:))';
    phi_y_2_2 = atand(tt2(2,:)./tt2(3,:))';
    
    F = L_test*tand(phi_x_2_2)/(cosd(alpha)*cosd(beta)-sind(alpha)*tand(phi_x_2_2)*cosd(beta)-sind(beta)*tand(phi_y_2_2)*cosd(alpha)) - A;
